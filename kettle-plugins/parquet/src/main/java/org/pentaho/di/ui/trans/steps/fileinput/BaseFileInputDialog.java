package org.pentaho.di.ui.trans.steps.fileinput;
...
public abstract class BaseFileInputDialog<T extends BaseFileInputStepMeta> extends BaseStepDialog implements
    StepDialogInterface {
  ...
  public BaseFileInputDialog( Shell parent, T in, TransMeta transMeta, String sname ) {
